...
namespace Lunatic.Application.Features.Projects.Commands.CreateTaskSectionCard {
	internal class AddTaskSectionCardCommandValidator : AbstractValidator<AddTaskSectionCardCommand> {
		private readonly IProjectRepository projectRepository;

		public AddTaskSectionCardCommandValidator(IProjectRepository projectRepository) {
