...
namespace Lunatic.UI.Services {
	public class TaskDataService : ITaskDataService {
		...
		public async Task<ApiResponse<int>> GetTaskPredictedDurationAsync(Guid taskId) {
		...
		public async Task<string> ConvertDaysToString(int toConvert) {
			var result = await httpClient.GetAsync($"{RequestUri}/convertDays/{toConvert}");
