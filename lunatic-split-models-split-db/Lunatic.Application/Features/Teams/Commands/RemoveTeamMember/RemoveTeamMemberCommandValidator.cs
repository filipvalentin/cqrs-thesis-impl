...
{
    internal class RemoveTeamMemberCommandValidator : AbstractValidator<RemoveTeamMemberCommand> {
        private readonly IUserRepository userRepository;

        private readonly ITeamRepository teamRepository;

        public RemoveTeamMemberCommandValidator(IUserRepository userRepository, ITeamRepository teamRepository) {
