...
namespace Lunatic.Application.Features.Projects.Commands.DeleteTaskSectionCard {
	internal class DeleteTaskSectionCardCommandValidator : AbstractValidator<DeleteTaskSectionCardCommand> {
		private readonly IProjectRepository projectRepository;

		public DeleteTaskSectionCardCommandValidator(IProjectRepository projectRepository) {
